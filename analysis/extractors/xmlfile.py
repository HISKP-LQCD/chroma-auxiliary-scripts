...
def main(options):
    for dirname in options.dirname:
        ...
        convert_to_md_time(dirname, 'n_steps')
...
def extract_n_steps(dirname):
    ...
    for xml_file in xml_files:
        ...
        number = float(tree.xpath('//hmc/Input/Params/HMCTrj/MDIntegrator/Integrator/n_steps/text()')[0])
