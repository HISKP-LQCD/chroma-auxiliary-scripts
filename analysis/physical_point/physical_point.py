...
def main():
    ...
    #ax.plot(amk_val**2 - 0.5 * ampi_val**2, ampi_val**2, linestyle='none', marker='o')
    #ax.set_xlabel(r'$(aM_K)^2 - \frac{1}{2} (a M_\pi)^2$')
    #ax.set_ylabel(r'$(a M_\pi)^2$')
    #util.save_figure(fig, 'plot-mpi2')

    #fig, ax = util.make_figure()
    #ax.plot(amk_val**2 - 0.5 * ampi_val**2, amk_val**2, linestyle='none', marker='o')
    #ax.set_xlabel(r'$(aM_K)^2 - \frac{1}{2} (a M_\pi)^2$')
    #ax.set_ylabel(r'$(a M_K)^2$')
    #util.save_figure(fig, 'plot-mk2')

    #fig, ax = util.make_figure()
    #ax.plot(amk_val**2 - 0.5 * ampi_val**2, ams, linestyle='none', marker='o')
    #ax.set_xlabel(r'$(aM_K)^2 - \frac{1}{2} (a M_\pi)^2$')
    #ax.set_ylabel(r'$a m_s$')
    #util.save_figure(fig, 'plot-ms')

    #fig, ax = util.make_figure()
    #ax.plot(amk_val**2 - 0.5 * ampi_val**2, aml, linestyle='none', marker='o')
    #ax.set_xlabel(r'$(aM_K)^2 - \frac{1}{2} (a M_\pi)^2$')
    #ax.set_ylabel(r'$a m_l$')
    #util.save_figure(fig, 'plot-ml')
    ...
    print('ampi_dist.shape:', ampi_dist.shape)
    print('amk_dist.shape:', amk_dist.shape)
    print('aB_dist.shape:', len(aB_dist))
    print('amcr_dist.shape:', len(amcr_dist))
    ...
    #aml_240_dist = [op.newton(lambda aml: gmor_pion(aml, *popt) - 240**2, np.min(aml))
